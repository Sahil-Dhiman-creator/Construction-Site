  ...
  return (
    ...
    style={{backgroundImage: `url(${backgroundImage})`}}>
        ...
        >
         ...
         >
            SAHIL DHIMAN
            <div className='w-[210px] h-[2px] bg-yellow-500'></div>
        </motion.h1>
         ...
         <p className='text-white text-[20px] '>
            ...
            Quae, odit? Harum nostrum distinctio praesentium delectus! 
            Tempora dicta ea, quae enim ex consequatur recusandae 
            officiis dolore nisi error eligendi at dolores!
          </p>
    ...
    <div className='w-[40%] flex-col justify-end items-end'>
        <motion.img
          initial='hidden'
          whileInView='visible'
          variants={zoomInVariants}
