          ...
          >
            {
              planning.map((item, index) => (
                <div 
                  key={index}
                  className='flex flex-col justify-center items-center gap-5 border-2 border-yellow-500 rounded-md p-6 cursor-pointer hover:bg-green-500'  
                >
                    <div>
                  <item.icon className='size-[80px] bg-yellow-500 hover:bg-green-400 hover:fill-yellow-500
