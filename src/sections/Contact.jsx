    ...
    id='about'>
      ...
      >
         ...
         >
              ...
              <input type="number" placeholder='Enter Your Number' className='px-6 py-3 border-[2px] border-black text-black rounded-lg w-full'/>
              <textarea name='' placeholder='Enter Your Message' id='' rows="4"
              className='px-6 py-3 border-[2px] border-black text-black rounded-lg w-full'></textarea>

              <motion.button
                variants={zoomInVariants}
                className='bg-yellow-500 hover:bg-red-700 hover:bg-black hover:text-white px-10 py-4 text-black font-bold rounded-lg w-full'
